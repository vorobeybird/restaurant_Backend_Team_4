...
const ReservationDialog = ({selectedCellData, openRForm, setOpenRForm, fetchReservationData}: any) => {
    ...
    return (
      ...
      <TextField
        ...
        value={formik.values.num_of_persons}
	    />
      </Grid>
      <Grid item md={6} xs={12}>
      <TextField
        ...
        onChange={formik.handleChange}
        value={formik.values.reserve_date}
	    />
        </Grid>
        <Grid container item xs={12} spacing={2}>
      <Grid item md={6} xs={12}>
