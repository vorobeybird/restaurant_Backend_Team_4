...
export const MyCards = ({  navigation: { goBack }, route }:{navigation:any, route:any}) => {
        ...
        <View style={styles.Wrapper}>
            ...
            {cart.card.length === 0 ? (
                <View style={styles.EmptyTextWrapper}>
                    <Text style={styles.EmptyText}>Похоже, вы пока не добавили карту</Text>
                </View>
            ):
                (   
                    <View>
                        {cart.card.map((item:any) => {console.log(item); return(
                            <View key={item.id} style={styles.FullWrapper}>
                                {item.type == 'visa' ? (
                                    <Image style={styles.typeImg} source={require('../../img/visa.png')}/>
                                ):(
                                    <Image style={styles.typeImg} source={require('../../img/mastercard.png')}/>
                                )}
