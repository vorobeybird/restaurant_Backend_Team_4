...
export const OrderDetails = ({  navigation: { goBack }, route }:{navigation:any, route:any}) => {
            ...
            <View style={styles.orderDishes}>
                ...
                {cart.dishes.map((item:any) => (
                    <View style={styles.contContent} key = {item.id}>
                        ...
                        <Text style={styles.simpText}>{item.price * item.cardQuantity} BYN</Text>
                    </View>
                ))}
                <View
                    style={{
                ...
                <View style={styles.TotalCounter}>
                    <Text style={styles.finHardText}>
                        ИТОГО
                    </Text>
                    <Text style={styles.finText}>
                        {cart.cardTotalAmount} BYN
                    </Text>
                </View>
            </View>
            <TouchableOpacity style={styles.butStyle} onPress={()=> {showToast(); onMakingOrder()}}>
